...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        printMessage("LOW");
        printMessage("MEDIUM");
        printMessage("high");//CTE yok,RTE yok AMAAAAA metod beklenen işlevi gerçekleştirmedi!!!
        printMessage("HIGH ");
        printMessage("......");
    ...
    public static void printMessageEnum(PasswordStrengthEnum strength){
       ...
       if (strength.equals(PasswordStrengthEnum.LOW)){
        //if(strength.ordinal()==0){ ordınalı ekleme yapmayacagımız zaman daha elverıslı olur
            System.out.println("Dikkat şifreniz yetersiz seviyededir!!!");
        ...
        System.out.println("Enum ismi :"+strength.name());//enum typeın ısmını gosterır
    }
