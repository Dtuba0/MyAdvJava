...
iki veya daha fazla thread'in birbirlerini bekleyerek sonsuza kadar bloklandığı
 bir durumdur. Bu durum, bir thread'in kilitli bir kaynağı beklerken, diğer
 thread'in de ilk thread'in kilitlediği başka bir kaynağı beklemesi sonucu oluşur.
  Bu durumda, hiçbir thread ilerleyemez ve program sonsuza kadar beklemede kalır.
 */
